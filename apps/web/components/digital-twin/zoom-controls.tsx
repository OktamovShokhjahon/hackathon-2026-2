...
/**
 * Zoom for the twin. The readout is not decoration: at 1× the whole body is in
    ...
    >
      ...
      {!atMin && (
        <button
          ...
          className="ml-0.5 rounded px-2 py-1 font-mono text-[10px] uppercase tracking-[0.12em] transition"
          style={{ color: onNavy ? "rgba(255,255,255,0.55)" : "var(--ink-faint)" }}
        >
          {t("twin.fit")}
        </button>
      )}
